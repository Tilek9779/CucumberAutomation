...
public class CwiseCASsteps {
    ...
    @Then("user clicks on {string} button and choose {string}")
    public void user_clicks_on_button_and_choose(String Sales, String ProductAndServices) {
